...
class CharacterManagerV2 {
  constructor(config = {}) {
    this.config = {
      ...
      maxChineseChars: config.maxChineseChars ?? 980,  // 统一为980英文字符上限
      ...config
    };
    ...
    this.growthTrace = new GrowthTraceSystem({
      protagonistId: this.config.protagonistId || 'xiangXiang',
  ...
  getCharacterGrowthProfile(characterId) {
    return this.growthTrace.getCharacterGrowthProfile(characterId || this.config.protagonistId || 'xiangXiang');
  }
